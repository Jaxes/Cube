...
public:
	...
	// Convenience overrides for handling mouse input.方便替代处理鼠标输入。
...
protected:
	...
	// Derived class should set these in derived constructor to customize starting values.派生类应该在派生构造函数中设置这些来自定义初始值。
