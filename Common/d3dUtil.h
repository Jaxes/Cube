...
public:
	///<summary>
	/// 
	/// Does not work with compressed formats.不适用于压缩格式。
	///</summary>
...
public:
	///<summary>
	/// Converts XMVECTOR to XMCOLOR, where XMVECTOR represents a color.将XMVECTOR转换为XMOLECTOR，其中XMVECTOR表示颜色。
	///</summary>
	...
	///<summary>
	/// Converts XMVECTOR to XMFLOAT4, where XMVECTOR represents a color.将XMVECTOR转换为XMFLOAT4，其中XMVECTOR表示颜色。
	///</summary>
